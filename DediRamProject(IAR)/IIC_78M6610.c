...
#include "string.h"
#include "dbg.h"
unsigned int defaultvalue_prj1[] = {
        0x00000000,0x00200000,0x00200000,0x00000000,
	0x00000000,0x00000000,0x00000000,0x00000000,
};
unsigned int defaultvalue_prj2[] = {
        0x00000000,0x00200000,0x00200000,0x00000000,
	0x00000000,0x00000000,0x00000000,0x00000000,
        0x00000000,0x00000000
};
unsigned int tempvalue_prj1[] = {
        0x008A2866,0x00431E5E,0x00431E5E,0x00000005,
	0x001B3BEA,0x00200000,0x00200000,0x00000001,
};
unsigned int tempvalue_prj2[] = {
        0x008A2866,0x00431E5E,0x00431E5E,0x00000007,
        0x00000007,0x001B3BEA,0x00200000,0x0023BEA3,
...
static void PROCESS_DECLARE(command_erase)
{
	...
	sram[VOFS_PAGE_SIZE] = info->uiPageSizeInByte;
        ...
        unsigned int prj_select = info->uiInitParameter;
        if(prj_select == 0)
        {
          write_sram(0x21,(unsigned int*)defaultvalue_prj1,sizeof(defaultvalue_prj1));
        }
        if(prj_select == 1)
        {
          write_sram(0x21,(unsigned int*)defaultvalue_prj2,sizeof(defaultvalue_prj2));
        }
