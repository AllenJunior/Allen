...
static void PROCESS_DECLARE(command_erase)
{
	...
	sram[VOFS_LAST_SUCCESS] = vector->uiStartPage;
        sram[VOFS_LENGTH] = vector->uiImageLength/(info->uiPageSizeInByte*16);//Sector Erase size 4KB
	sram[VOFS_PAGE_SIZE] = info->uiPageSizeInByte*16;//Sector Erase size 4KB
