...
class CDlg_ATtinyISP_1 : public CMFCPropertyPage
{
	DECLARE_DYNAMIC(CDlg_ATtinyISP_1)

public:
	CDlg_ATtinyISP_1(struct chip_info_c * ChipInfo, unsigned char *RegisterBuff, unsigned long BuffLen, unsigned long *pDataLen, CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlg_ATtinyISP_1();

// Dialog Data
	enum { IDD = IDD_ATtinyXISP_1 };
