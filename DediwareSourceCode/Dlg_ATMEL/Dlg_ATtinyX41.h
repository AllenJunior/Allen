...
class CDlg_ATtinyX41 : public CMFCPropertyPage
{
	DECLARE_DYNAMIC(CDlg_ATtinyX41)

public:
	CDlg_ATtinyX41(struct chip_info_c * ChipInfo, unsigned char *RegisterBuff, unsigned long BuffLen, unsigned long *pDataLen, CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlg_ATtinyX41();

// Dialog Data
	enum { IDD = IDD_ATtinyX41 };
