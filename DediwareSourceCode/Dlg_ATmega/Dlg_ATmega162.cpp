// Dlg_ATmega162.cpp : implementation file
//
...
// Dlg_ATmega162 dialog

IMPLEMENT_DYNAMIC(CDlg_ATmega162, CMFCPropertyPage)

CDlg_ATmega162::CDlg_ATmega162(struct chip_info_c *ChipInfo, unsigned char *RegisterBuff, unsigned long BuffLen, unsigned long *pDataLen, CWnd* pParent /*=NULL*/)
: CMFCPropertyPage(CDlg_ATmega162::IDD),
m_ChipInfo(ChipInfo),
...
CDlg_ATmega162::~CDlg_ATmega162()
{
}

void CDlg_ATmega162::DoDataExchange(CDataExchange* pDX)
{
	CMFCPropertyPage::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_COMBO1, m_M161C);
...
BEGIN_MESSAGE_MAP(CDlg_ATmega162, CMFCPropertyPage)
	ON_CBN_SELCHANGE(IDC_COMBO1, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO2, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO3, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO4, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO5, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO6, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO7, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO8, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO9, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO10, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO11, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO12, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO13, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO14, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO15, &CDlg_ATmega162::OnCbnSelchangeCombo)
	ON_BN_CLICKED(IDC_CHECK1, &CDlg_ATmega162::OnBnClickedEnable)
END_MESSAGE_MAP()


// Dlg_ATmega162 message handlers
BOOL CDlg_ATmega162::OnInitDialog()
{
	...
	//Extended Fuse
	m_M161C.InsertString(m_M161C.GetCount(), L"0 = Enable ATmega161 compaatibility Mode");
	m_M161C.InsertString(m_M161C.GetCount(), L"1 = Disable ATmega161 compaatibility Mode");
	...
	m_BOOTSZ.InsertString(m_BOOTSZ.GetCount(), L"00 = Boot Size 1024 words");//initial value
	...
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"10,0010 = Int.RC OSC:8MHz,StartupTime:14CK+64ms");  	// 5 = 0x22	//Initial
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"00,0100 = Ext.Low.freq.crystal,StartupTime:1KCK"); 		// 6 = 0x04
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"01,0100 = Ext.Low.freq.crystal,StartupTime:1KCK+4.1ms"); 	// 7 = 0x14
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"10,0100 = Ext.Low.freq.crystal,StartupTime:1KCK+64ms");  	// 8 = 0x24
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"00,0101 = Ext.Low.freq.crystal,StartupTime:32KCK"); 		// 9 = 0x05
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"01,0101 = Ext.Low.freq.crystal,StartupTime:32KCK+4.1ms"); 	// 10 = 0x15
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"10,0101 = Ext.Low.freq.crystal,StartupTime:32KCK+64ms");  	// 11 = 0xx25
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"00,0110 = Ext.Low.freq.crystal,Int.Cap,StartupTime:1KCK"); 		// 12 = 0x06
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"01,0110 = Ext.Low.freq.crystal,Int.Cap,StartupTime:1KCK+4.1ms"); 	// 13 = 0x16
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"10,0110 = Ext.Low.freq.crystal,Int.Cap,StartupTime:1KCK+64ms");  	// 14 = 0xx26
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"00,0111 = Ext.Low.freq.crystal,Int.Cap,StartupTime:32CK"); 		// 15 = 0x07
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"01,0111 = Ext.Low.freq.crystal,Int.Cap,StartupTime:32CK+4.1ms"); 	// 16 = 0x17
	m_CKSEL.InsertString(m_CKSEL.GetCount(), L"10,0111 = Ext.Low.freq.crystal,Int.Cap,StartupTime:32CK+65ms"); 	// 17 = 0x27
...
BOOL CDlg_ATmega162::OnSetActive()
{
	if (*m_pDataLen != NULL)
	{
		CButton* Encheck = (CButton*)GetDlgItem(IDC_CHECK1);
		Encheck->SetCheck(1);
		m_M161C.EnableWindow(TRUE);
		...
		if ((ExtendedFuse & 0x10) == 0x10)
			...
			m_M161C.SetCurSel(0);
		//BODLevel
		if ((ExtendedFuse & 0x0E) == 0x0E)
			m_BODLevel.SetCurSel(3);
		else if ((ExtendedFuse & 0x0E) == 0x0C)
			m_BODLevel.SetCurSel(2);
		else if ((ExtendedFuse & 0x0E) == 0x0A)
			m_BODLevel.SetCurSel(1);
		else if ((ExtendedFuse & 0x0E) == 0x08)
...
void CDlg_ATmega162::OnCbnSelchangeCombo()
{
	...
	//M161C
	ExtendedFuse &= 0xEF;
	if (m_M161C.GetCurSel() == 1)
		ExtendedFuse |= 0x10;
	else if (m_M161C.GetCurSel() == 0)
		ExtendedFuse |= 0x00;
...
LRESULT CDlg_ATmega162::OnWizardNext()
{
	OnOK();
	return CMFCPropertyPage::OnWizardNext();

}
LRESULT CDlg_ATmega162::OnWizardBack()
{
	OnOK();
	return CMFCPropertyPage::OnWizardBack();
}

void CDlg_ATmega162::OnBnClickedEnable()
{
	CButton* Encheck = (CButton*)GetDlgItem(IDC_CHECK1);
	int state = Encheck->GetCheck();
	if (state == 1)
