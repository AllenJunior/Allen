...
class CDlg_ATmega48 : public CMFCPropertyPage
{
	DECLARE_DYNAMIC(CDlg_ATmega48)

public:
	CDlg_ATmega48(struct chip_info_c * ChipInfo, unsigned char *RegisterBuff, unsigned long BuffLen, unsigned long *pDataLen, CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlg_ATmega48();

// Dialog Data
	enum { IDD = IDD_ATmega48 };
