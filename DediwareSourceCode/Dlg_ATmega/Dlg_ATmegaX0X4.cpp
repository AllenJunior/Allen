// Dlg_ATmegaX0X4.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CDlg_ATmegaX0X4, CMFCPropertyPage)

CDlg_ATmegaX0X4::CDlg_ATmegaX0X4(struct chip_info_c *ChipInfo, unsigned char *RegisterBuff, unsigned long BuffLen, unsigned long *pDataLen, CWnd* pParent /*=NULL*/)
: CMFCPropertyPage(CDlg_ATmegaX0X4::IDD),
m_ChipInfo(ChipInfo),
...
CDlg_ATmegaX0X4::~CDlg_ATmegaX0X4()
{
}

void CDlg_ATmegaX0X4::DoDataExchange(CDataExchange* pDX)
{
	CMFCPropertyPage::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_CHECK1, Option_enable);
	DDX_Control(pDX, IDC_COMBO1, m_BODLevel);
	DDX_Control(pDX, IDC_COMBO2, m_OCDEN);
	DDX_Control(pDX, IDC_COMBO3, m_JTAGEN);
...
BEGIN_MESSAGE_MAP(CDlg_ATmegaX0X4, CMFCPropertyPage)
	ON_CBN_SELCHANGE(IDC_COMBO1, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO2, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO3, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO4, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO5, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO6, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO7, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO8, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO9, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO10, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO11, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO12, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO13, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_CBN_SELCHANGE(IDC_COMBO14, &CDlg_ATmegaX0X4::OnCbnSelchangeCombo)
	ON_BN_CLICKED(IDC_CHECK1, &CDlg_ATmegaX0X4::OnBnClickedEnable)
END_MESSAGE_MAP()


// Dlg_ATmegaX0X4 message handlers
BOOL CDlg_ATmegaX0X4::OnInitDialog()
{
...
BOOL CDlg_ATmegaX0X4::OnSetActive()
{
	if (*m_pDataLen != NULL)
	{
		CButton* Encheck = (CButton*)GetDlgItem(IDC_CHECK1);
...
void CDlg_ATmegaX0X4::OnCbnSelchangeCombo()
{
...
LRESULT CDlg_ATmegaX0X4::OnWizardNext()
{
	OnOK();
	return CMFCPropertyPage::OnWizardNext();

}
LRESULT CDlg_ATmegaX0X4::OnWizardBack()
{
	OnOK();
	return CMFCPropertyPage::OnWizardBack();
}

void CDlg_ATmegaX0X4::OnBnClickedEnable()
{
	CButton* Encheck = (CButton*)GetDlgItem(IDC_CHECK1);
	int state = Encheck->GetCheck();
	if (state == 1)
